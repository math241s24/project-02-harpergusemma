...
In the figure below, comparisons of fish count (blue histogram) and the amount of times that fish were mentioned in the legislature (black line) showed no significant similarities, except for an interesting peak in the amount of times fish were mentioned in 1998 co-occuring with a dip in fish count.

![](wordsandfish.png){fig-align="center"}
...
![](wordsandpermit.png){fig-align="center"}
