...
We chose this data because we think it provides a lot of information across both spatial and temporal scales about fish populations that could reflect some interesting environmental and political variables and that could make for an interesting visualization. We all have pretty environmentally focused interests, so we thought it could be cool to examine an environmental question for this project.
